...
.PHONY: all flash_image kernelis bootloaderis clean always
...
flash_image: $(BUILD_DIR)/main_flash.img

$(BUILD_DIR)/main_flash.img: bootloaderis kernelis
	dd if=/dev/zero of=$(BUILD_DIR)/main_flash.img bs=512 count=2880
