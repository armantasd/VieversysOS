...
void InicijuotiGDT()
{
	...
	gdt_ptr->ptr = malloc(sizeof(GDTirasas) * 7);
	gdt_ptr->dydis = sizeof(GDTirasas) * 7 - 1;
	...
	*gdt_0 = 0;
	...
	GDTirasas* gdt_data = gdt_ptr->ptr + 2;
	gdt_data->dydis = 0xffff;
	gdt_data->adresas_z = 0;
	gdt_data->adresas_v = 0;
	gdt_data->prieeigos_baitas = 0b10010010;
	gdt_data->veliavos = 0b10101111;
	gdt_data->adresas_a = 0;
	GDTirasas* gdt_ndt_kodas = gdt_ptr->ptr + 4;
	...
	GDTSistemosIrasas* tss_irasas = (GDTSistemosIrasas*) (gdt_ptr->ptr + 5);
